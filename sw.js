...
const urlsToCache = [
  ...
  '/bennet_salon/vendor/react.production.min.js',
  '/bennet_salon/vendor/react-dom.production.min.js',
  '/bennet_salon/vendor/babel.min.js',
  '/bennet_salon/vendor/bcrypt.min.js',
  '/bennet_salon/vendor/tailwind-browser.js',
  '/bennet_salon/vendor/lucide/lucide.css',
  '/bennet_salon/vendor/lucide/lucide.woff2',
  '/bennet_salon/utils/push-config.js',
  '/bennet_salon/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/bennet_salon/icons/icon-192x192.png',
    badge: '/bennet_salon/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/bennet_salon/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/bennet_salon/admin.html';
  event.waitUntil(
